...
class Directory_Admin {
    ...
    public function add_admin_menu() {
        ...
        add_submenu_page( 'wpd-main-menu', __( 'تنظیمات ظاهری', 'wp-directory' ), __( 'تنظیمات ظاهری', 'wp-directory' ), 'manage_options', 'wpd-appearance', [ $this, 'render_appearance_page' ] );
        add_submenu_page( 'wpd-main-menu', __( 'تنظیمات افزونه', 'wp-directory' ), __( 'تنظیمات افزونه', 'wp-directory' ), 'manage_options', 'wpd-settings', [ $this, 'render_settings_page' ] );
    ...
    public function enqueue_admin_scripts( $hook ) {
        if ( strpos($hook, 'page_wpd-') === false && strpos($hook, 'toplevel_page_wpd-main-menu') === false ) {
            return;
        }
    ...
    public function render_settings_page() {
        ...
        <div class="wrap wpd-settings-wrap">
            ...
            <form action="options.php" method="post">
                ...
                <div id="tab-sms" class="wpd-settings-tab"><div id="wpd-sms-settings-wrapper"><?php do_settings_sections( 'wpd_settings_sms' ); ?></div></div>
    ...
    public function render_appearance_page() {
        ?>
        <div class="wrap wpd-settings-wrap">
            <h1><?php _e( 'تنظیمات ظاهری', 'wp-directory' ); ?></h1>
            <form action="options.php" method="post">
                <?php settings_fields( 'wpd_settings_group' ); ?>
    ...
    public function render_appearance_settings() {
        ...
        <div class="wpd-sub-nav-tab-wrapper">
            <a href="#appearance/global" data-sub-tab="global" class="nav-tab"><?php _e('عمومی', 'wp-directory'); ?></a>
            <a href="#appearance/archive" data-sub-tab="archive" class="nav-tab"><?php _e('آرشیو و آیتم‌ها', 'wp-directory'); ?></a>
            <a href="#appearance/single" data-sub-tab="single" class="nav-tab"><?php _e('صفحه تکی آگهی', 'wp-directory'); ?></a>
            <a href="#appearance/forms" data-sub-tab="forms" class="nav-tab"><?php _e('فرم‌ها و فیلترها', 'wp-directory'); ?></a>
            <a href="#appearance/dashboard" data-sub-tab="dashboard" class="nav-tab"><?php _e('داشبورد کاربری', 'wp-directory'); ?></a>
            <a href="#appearance/custom_css" data-sub-tab="custom_css" class="nav-tab"><?php _e('CSS سفارشی', 'wp-directory'); ?></a>
        </div>
        ...
        return <<<'JS'
            jQuery(document).ready(function($){
                ...
                function toggleSmsFields() {
                    ...
                    var $wrapper = $('#wpd-sms-settings-wrapper');
                    $wrapper.find('.sms-provider-field').hide();
                    if (provider) {
                        $wrapper.find('.' + provider + '-field').show();
                    }
                }
