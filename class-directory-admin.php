...
class Directory_Admin {
    ...
    public function render_settings_page() {
        ...
        <div class="wrap wpd-settings-wrap">
            ...
            <h2 class="nav-tab-wrapper wpd-nav-tab-wrapper">
                ...
                <a href="#appearance" data-tab="appearance" class="nav-tab"><?php echo Directory_Main::get_term('admin_menu_appearance'); ?></a>
    ...
    public function register_settings() {
        ...
        $this->add_all_appearance_fields('wpd_appearance_section');
    }
        ...
        foreach ($input as $section => $values) {
            ...
            foreach ($values as $key => $value) {
                if (strpos($key, '_color') !== false) {
                    ...
                    $new_input[$section][$key] = wp_strip_all_tags($value);
                } else {
    ...
    private function add_all_appearance_fields($section_id) {
        // Global
        add_settings_field('global_primary_color', __('رنگ اصلی', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'global_primary_color']);
        add_settings_field('global_secondary_color', __('رنگ ثانویه', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'global_secondary_color']);
        add_settings_field('global_text_color', __('رنگ متن', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'global_text_color']);
        add_settings_field('global_background_color', __('رنگ پس‌زمینه', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'global_background_color']);
        add_settings_field('global_border_color', __('رنگ خطوط', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'global_border_color']);
        add_settings_field('global_main_font', 'فونت اصلی', [$this, 'render_select_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'global_main_font', 'options' => ['vazir' => 'وزیرمتن', 'iransans' => 'ایران سنس', 'dana' => 'دانا', 'custom' => 'استفاده از فونت قالب']]);
        add_settings_field('global_base_font_size', __('اندازه فونت پایه', 'wp-directory'), [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'global_base_font_size', 'desc' => 'مثال: 16px']);
        add_settings_field('global_main_border_radius', __('شعاع لبه عناصر', 'wp-directory'), [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'global_main_border_radius', 'desc' => 'مثال: 8px']);
        add_settings_field('global_button_border_radius', __('شعاع لبه دکمه‌ها', 'wp-directory'), [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'global_button_border_radius', 'desc' => 'مثال: 5px']);

        // Archive
        add_settings_field('archive_card_bg_color', __('رنگ پس‌زمینه کارت (آرشیو)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'archive_card_bg_color']);
        add_settings_field('archive_card_border_shadow', __('حاشیه و سایه کارت (آرشیو)', 'wp-directory'), [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'archive_card_border_shadow', 'desc' => 'مثال: 1px solid #eee یا 0 5px 15px rgba(0,0,0,0.1)']);
        add_settings_field('archive_title_color', __('رنگ عنوان (آرشیو)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'archive_title_color']);
        add_settings_field('archive_title_font_size', __('اندازه فونت عنوان (آرشیو)', 'wp-directory'), [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'archive_title_font_size', 'desc' => 'مثال: 1.2em']);
        add_settings_field('archive_meta_color', __('رنگ متاداده (آرشیو)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'archive_meta_color']);
        add_settings_field('archive_meta_font_size', __('اندازه فونت متاداده (آرشیو)', 'wp-directory'), [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'archive_meta_font_size', 'desc' => 'مثال: 0.9em']);
        add_settings_field('archive_featured_badge_bg', __('پس‌زمینه برچسب ویژه', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'archive_featured_badge_bg']);
        add_settings_field('archive_featured_badge_color', __('رنگ متن برچسب ویژه', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'archive_featured_badge_color']);

        // Single
        add_settings_field('single_main_title_color', __('رنگ عنوان اصلی (صفحه تکی)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'single_main_title_color']);
        add_settings_field('single_main_title_font_size', __('اندازه فونت عنوان اصلی (صفحه تکی)', 'wp-directory'), [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'single_main_title_font_size', 'desc' => 'مثال: 2em']);
        add_settings_field('single_section_title_color', __('رنگ عناوین بخش‌ها (صفحه تکی)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'single_section_title_color']);

        // Forms
        add_settings_field('forms_input_bg_color', __('پس‌زمینه فیلدها (فرم‌ها)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'forms_input_bg_color']);
        add_settings_field('forms_input_text_color', __('رنگ متن فیلدها (فرم‌ها)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'forms_input_text_color']);
        add_settings_field('forms_input_border_color', __('رنگ حاشیه فیلدها (فرم‌ها)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'forms_input_border_color']);
        add_settings_field('forms_input_focus_border_color', __('رنگ حاشیه در حالت فوکوس (فرم‌ها)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'forms_input_focus_border_color']);
        add_settings_field('forms_primary_button_bg_color', __('پس‌زمینه دکمه اصلی', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'forms_primary_button_bg_color']);
        add_settings_field('forms_primary_button_text_color', __('رنگ متن دکمه اصلی', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'forms_primary_button_text_color']);

        // Dashboard
        add_settings_field('dashboard_nav_bg_color', __('پس‌زمینه تب عادی (داشبورد)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'dashboard_nav_bg_color']);
        add_settings_field('dashboard_nav_text_color', __('رنگ متن تب عادی (داشبورد)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'dashboard_nav_text_color']);
        add_settings_field('dashboard_nav_active_bg_color', __('پس‌زمینه تب فعال (داشبورد)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'dashboard_nav_active_bg_color']);
        add_settings_field('dashboard_nav_active_text_color', __('رنگ متن تب فعال (داشبورد)', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'dashboard_nav_active_text_color']);

        // Custom CSS
        add_settings_field('custom_css', __('کد CSS سفارشی', 'wp-directory'), [$this, 'render_textarea_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'custom_css', 'desc' => 'کدهای CSS وارد شده در این بخش، در انتهای تمام استایل‌های افزونه بارگذاری می‌شوند.']);
    }
    ...
    public function render_payments_ui() {
        ...
        foreach ($gateways as $id => $label) {
            $field_id_attr = $this->_get_field_id_attr('payments', $id . '_apikey');
            ?>
            <div class="wpd-accordion-item">
                ...
                <div class="wpd-accordion-content">
                    <table class="form-table">
                        ...
                        <tr>
                            <th><label for="<?php echo esc_attr($field_id_attr); ?>"><?php _e('کلید API / مرچنت کد', 'wp-directory'); ?></label></th>
                            <td>
                                <?php $this->render_text_input_element(['section' => 'payments', 'id' => $id.'_apikey']); ?>
                                <button type="button" class="button button-secondary wpd-verify-service-btn" data-service="<?php echo esc_attr($id); ?>" data-field-id="<?php echo esc_attr($field_id_attr); ?>">
            ...
            <div class="wpd-accordion-item">
                ...
                <div class="wpd-accordion-content">
                    <table class="form-table">
                        ...
                        <?php if ($id === 'kavenegar'): 
                            $field_id_attr = $this->_get_field_id_attr('sms', 'kavenegar_api_key');
                        ?>
                        <tr>
                            <th><label for="<?php echo esc_attr($field_id_attr); ?>"><?php _e('کلید API کاوه نگار', 'wp-directory'); ?></label></th>
                            <td>
                                <?php $this->render_text_input_element(['section' => 'sms', 'id' => 'kavenegar_api_key']); ?>
                                <button type="button" class="button button-secondary wpd-verify-service-btn" data-service="kavenegar" data-field-id="<?php echo esc_attr($field_id_attr); ?>">
                                    <?php echo Directory_Main::get_term('button_check_connection'); ?>
                                </button>
                                <span class="wpd-verification-status"></span>
                            </td>
                        ...
                        <?php elseif ($id === 'farazsms'): 
                            $api_field_id_attr = $this->_get_field_id_attr('sms', 'farazsms_api_key');
                            $sender_field_id_attr = $this->_get_field_id_attr('sms', 'farazsms_sender_number');
                        ?>
                        <tr>
                            <th><label for="<?php echo esc_attr($api_field_id_attr); ?>"><?php _e('کلید API فراز اس ام اس', 'wp-directory'); ?></label></th>
                            <td>
                                <?php $this->render_text_input_element(['section' => 'sms', 'id' => 'farazsms_api_key']); ?>
                                 <button type="button" class="button button-secondary wpd-verify-service-btn" data-service="farazsms" data-field-id="<?php echo esc_attr($api_field_id_attr); ?>" data-extra-field-id="<?php echo esc_attr($sender_field_id_attr); ?>">
                                    <?php echo Directory_Main::get_term('button_check_connection'); ?>
                                </button>
                                <span class="wpd-verification-status"></span>
                            </td>
                        ...
                        <tr>
                            <th><label for="<?php echo esc_attr($sender_field_id_attr); ?>"><?php _e('شماره فرستنده فراز اس ام اس', 'wp-directory'); ?></label></th>
    ...
    private function _get_field_id_attr($section, $id) {
        $full_id_name = "wpd_settings[{$section}][{$id}]";
        $full_id_attr = str_replace(['[', ']'], '_', $full_id_name);
        return rtrim($full_id_attr, '_');
    }
    ...
    public function render_page_dropdown_element($args) {
        ...
        wp_dropdown_pages([
            ...
            'id' => $this->_get_field_id_attr($args['section'], $id),
            'selected' => $value,
    ...
    public function render_text_input_element($args){
        ...
        $id = $args['id'];
        $field_id_attr = $this->_get_field_id_attr($section, $id);
        $field_name = "wpd_settings[{$section}][{$id}]";

        $options = Directory_Main::get_option($section, []);
        $value = $options[$id] ?? ($args['default'] ?? '');
        
        $placeholder = $args['placeholder'] ?? $args['default'] ?? '';
        echo '<input type="text" id="'.esc_attr($field_id_attr).'" name="'.esc_attr($field_name).'" value="'.esc_attr($value).'" class="regular-text" placeholder="'.esc_attr($placeholder).'" />';
    ...
    public function render_color_picker_element($args){
        ...
        echo '<input type="text" name="'.esc_attr($field_name).'" value="'.esc_attr($value).'" class="wpd-color-picker" />';
    }
    ...
    public function render_select_element($args){
        ...
        echo '<select id="'.esc_attr($field_id_attr).'" name="'.esc_attr($field_name).'">';
    ...
    public function render_textarea_element($args) {
        ...
        // BUG FIX: Check if the value is an array due to old data structure.
        if (is_array($value) && isset($value[$id])) {
            $value = $value[$id];
        }

        echo '<textarea id="'.esc_attr($field_id_attr).'" name="'.esc_attr($field_name).'" class="large-text" rows="10" style="direction: ltr; text-align: left;">'.esc_textarea($value).'</textarea>';
        if(isset($args['desc'])) echo '<p class="description">'.wp_kses_post($args['desc']).'</p>';
    }
    ...
    private function get_settings_page_js() {
        ...
        return <<<JS
            jQuery(document).ready(function($){
                // --- Tabbing Logic ---
                function setupTabs() {
                    var \$wrapper = $('.wpd-nav-tab-wrapper');
                ...
                function activateTabFromHash() {
                    ...
                    var mainTabId = hash || $('.wpd-nav-tab-wrapper .nav-tab:first').data('tab');
