...
class Directory_Admin {
    ...
    public function __construct() {
        ...
        // BUG FIX: Use admin_head hooks for immediate CSS injection to hide taxonomies
        add_action( 'admin_head-post.php', [ $this, 'hide_dynamic_taxonomies_css' ] );
        add_action( 'admin_head-post-new.php', [ $this, 'hide_dynamic_taxonomies_css' ] );
    }
    ...
    /**
     * BUG FIX: New function to inject CSS directly into the admin head.
     * This ensures dynamic taxonomies are hidden before the page renders, preventing flashing.
     */
    public function hide_dynamic_taxonomies_css() {
        global $post_type;
        if ( 'wpd_listing' === $post_type ) {
            echo '<style>
                div[id^="taxonomy-"]:not(#taxonomy-wpd_listing_categorydiv):not(#taxonomy-wpd_listing_locationdiv) {
                    display: none;
                }
            </style>';
        }
