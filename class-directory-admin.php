...
class Directory_Admin {
    ...
    public function __construct() {
        ...
        // NEW: Add handler for creating default pages
        add_action( 'admin_init', [ $this, 'create_default_pages_handler' ] );
    }
    ...
    public function render_help_tab_content() {
        ...
        <table class="widefat striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <p><?php _e('نمایش یک لیست از آگهی‌ها در هر نقطه از سایت. با پارامترهایی مانند <code>type</code>, <code>count</code>, <code>orderby</code> و <code>order</code> می‌توانید لیست را سفارشی‌سازی کنید.', 'wp-directory'); ?></p>
        ...
        <p><?php _e('<strong>مدیریت ظاهری پیشرفته:</strong> از تب "مدیریت ظاهری" می‌توانید رنگ‌ها، فونت‌ها و استایل‌های اصلی افزونه را بدون نیاز به کدنویسی تغییر دهید.', 'wp-directory'); ?></p>
        <?php
    }
        ...
        foreach ($input as $section => $values) {
            if (is_array($values)) {
                foreach ($values as $key => $value) {
                    ...
                    } elseif ( in_array($key, ['font_size_title', 'font_size_body', 'font_size_button']) ) {
                        $sanitized_value = sanitize_text_field($value); 
                    } elseif ( in_array($key, ['font_weight_title', 'font_weight_body', 'font_weight_button']) ) {
                        $sanitized_value = absint($value); 
                    } elseif ( in_array($key, ['button_radius_value', 'border_radius_value']) ) {
                        $sanitized_value = sanitize_text_field($value);
                    }
                    else {
                        $sanitized_value = sanitize_text_field($value);
    ...
    private function add_appearance_fields($section_id){
        // NEW: Color settings
        add_settings_field('appearance_primary_color', __('رنگ اصلی', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'primary_color']);
        add_settings_field('appearance_secondary_color', __('رنگ ثانویه', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'secondary_color']);
        add_settings_field('appearance_text_color', __('رنگ متن', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'text_color']);
        add_settings_field('appearance_background_color', __('رنگ پس‌زمینه', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'background_color']);
        add_settings_field('appearance_border_color', __('رنگ خطوط', 'wp-directory'), [$this, 'render_color_picker_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'border_color']);
        add_settings_field('appearance_button_radius', __('شعاع لبه دکمه‌ها', 'wp-directory'), [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'button_radius_value', 'desc' => 'مثال: 5px یا 0.5em']);
        add_settings_field('appearance_border_radius', __('شعاع لبه عناصر', 'wp-directory'), [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'border_radius_value', 'desc' => 'مثال: 5px یا 0.5em']);
        ...
        add_settings_field('appearance_typography_google_font_url', 'لینک فونت گوگل', [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'google_font_url', 'desc' => 'فقط در صورت استفاده از فونت سفارشی گوگل، لینک آن را وارد کنید.']);
        add_settings_field('appearance_typography_google_font_family', 'نام فونت گوگل', [$this, 'render_text_input_element'], 'wpd_settings_appearance', $section_id, ['section' => 'appearance', 'id' => 'google_font_family', 'desc' => 'فقط در صورت استفاده از فونت سفارشی گوگل، نام آن را وارد کنید.']);
    }
...
JS;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description"><?php _e('این ابزار برگه‌های ضروری برای ثبت آگهی، داشبورد کاربری و آرشیو آگهی‌ها را می‌سازد.', 'wp-directory'); ?></p>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    /**
     * Handler for creating default plugin pages
     */
    public function create_default_pages_handler() {
        ...
        add_action('admin_notices', function() {
            echo '<div class="notice notice-success is-dismissible"><p>' . __('برگه‌های پیش‌فرض افزونه با موفقیت ساخته یا به‌روزرسانی شدند.', 'wp-directory') . '</p></div>';
        });
    }
