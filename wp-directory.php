...
// **تغییر نام کلاس برای جلوگیری از تداخل و افزایش خوانایی**
if ( ! class_exists( 'WPD_Plugin_Loader' ) ) {

    /**
     * کلاس اصلی افزونه که تمام بخش‌ها را مدیریت و راه‌اندازی می‌کند.
     */
    final class WPD_Plugin_Loader {
        ...
        private function includes() {
            ...
            require_once WPD_PLUGIN_PATH . 'class-directory-dynamic-styles.php';
        }
        ...
        public function init_plugin() {
            // این تابع کلاس اصلی منطق افزونه را نمونه‌سازی می‌کند
...
/**
 * تابع اصلی برای اجرای افزونه
 * @return WPD_Plugin_Loader
 */
function wpd_run_plugin() {
    return WPD_Plugin_Loader::instance();
}
