...
if ( ! class_exists( 'Directory_Main' ) ) {
    ...
    final class Directory_Main {
        ...
        private function init_classes() {
            ...
            $this->dynamic_styles = new Directory_Dynamic_Styles();
        }
        ...
        public static function get_default_terms() {
            return [
                ...
                'upgrade_package' => __( 'بسته ارتقا', 'wp-directory' ),
                'select_package' => __( 'انتخاب بسته', 'wp-directory' ),
                'listing_duration' => __( 'مدت اعتبار آگهی', 'wp-directory' ),
                
                // Admin Menu & Page Titles
                'admin_menu_main' => __( 'نیلای دایرکتوری', 'wp-directory' ),
                'admin_menu_packages' => __( 'بسته‌های عضویت', 'wp-directory' ),
                'admin_menu_upgrades' => __( 'بسته‌های ارتقا', 'wp-directory' ),
                'admin_menu_transactions' => __( 'تراکنش‌ها', 'wp-directory' ),
                'admin_menu_reports' => __( 'گزارشات', 'wp-directory' ),
                'admin_menu_appearance' => __( 'تنظیمات ظاهری', 'wp-directory' ),
                'admin_menu_settings' => __( 'تنظیمات افزونه', 'wp-directory' ),
                'admin_menu_tools' => __( 'ابزارها', 'wp-directory' ),
                'settings_page_title' => __( 'تنظیمات افزونه نیلای دایرکتوری', 'wp-directory' ),
                'appearance_page_title' => __( 'تنظیمات ظاهری', 'wp-directory' ),
                'transactions_page_title' => __( 'تراکنش‌ها', 'wp-directory' ),
                'reports_page_title' => __( 'گزارشات نیلای دایرکتوری', 'wp-directory' ),
                'tools_page_title' => __( 'ابزارها و وضعیت سیستم', 'wp-directory' ),
                'add_manual_transaction_title' => __( 'افزودن تراکنش دستی', 'wp-directory' ),

                // Settings Tabs
                'settings_tab_general' => __( 'عمومی', 'wp-directory' ),
                'settings_tab_payments' => __( 'پرداخت', 'wp-directory' ),
                'settings_tab_sms' => __( 'پیامک', 'wp-directory' ),
                'settings_tab_notifications' => __( 'اعلان‌ها', 'wp-directory' ),
                'settings_tab_terminology' => __( 'مدیریت اصطلاحات', 'wp-directory' ),
                'settings_tab_help' => __( 'راهنما', 'wp-directory' ),

                // Appearance Sub-Tabs
                'appearance_tab_global' => __( 'عمومی', 'wp-directory' ),
                'appearance_tab_archive' => __( 'آرشیو و آیتم‌ها', 'wp-directory' ),
                'appearance_tab_single' => __( 'صفحه تکی آگهی', 'wp-directory' ),
                'appearance_tab_forms' => __( 'فرم‌ها و فیلترها', 'wp-directory' ),
                'appearance_tab_dashboard' => __( 'داشبورد کاربری', 'wp-directory' ),
                'appearance_tab_custom_css' => __( 'CSS سفارشی', 'wp-directory' ),
                
                // Tools Tabs
                'tools_tab_system_status' => __( 'وضعیت سیستم', 'wp-directory' ),
                'tools_tab_maintenance' => __( 'ابزارهای نگهداری', 'wp-directory' ),
                'tools_tab_data_management' => __( 'مدیریت داده‌ها', 'wp-directory' ),
                
                // Buttons
                'button_add_new' => __( 'افزودن جدید', 'wp-directory' ),
                'button_add_manual_transaction' => __( 'افزودن تراکنش دستی', 'wp-directory' ),
                'button_filter' => __( 'فیلتر', 'wp-directory' ),
                'button_check_connection' => __( 'بررسی اتصال', 'wp-directory' ),
                'button_edit_template' => __( 'ویرایش قالب', 'wp-directory' ),
                'button_settings' => __( 'تنظیمات', 'wp-directory' ),
                
                // Default Appearance Values (Not for translation, but for management)
                'appearance_primary_color' => '#0073aa',
                'appearance_secondary_color' => '#f0f0f0',
                'appearance_text_color' => '#444444',
                'appearance_background_color' => '#ffffff',
                'appearance_border_color' => '#dddddd',
                'appearance_button_radius' => '4px',
                'appearance_main_font' => 'vazir'
            ];
        }
